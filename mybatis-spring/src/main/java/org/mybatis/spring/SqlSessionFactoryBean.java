...
public class SqlSessionFactoryBean
  ...
  /**
   * 别名 <typeAliases> <typeAlias type="com.eleven.entity.Employee" alias="employee"></typeAlias> </typeAliases>
   */
  ...
  /**
   * 通过该开关来控制只支持开启哪种别名 factoryBean.setTypeAliasesPackage("com.eleven.entity");
  ...
  protected SqlSessionFactory buildSqlSessionFactory() throws Exception {
     ...
     *
     *       factoryBean.setTypeAliasesPackage("com.eleven.entity"); return factoryBean; }
     *
     *
